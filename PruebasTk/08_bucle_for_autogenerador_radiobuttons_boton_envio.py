...
titulo = Label(root, text="Selecciona la respuesta correcta.").grid(row=0)
titulo1 = Radiobutton(root, text="Esta es la primera opción.", value=1, variable=x).grid(row=1)
titulo2 = Radiobutton(root, text="Esta es la segunda opción.", value=2, variable=x).grid(row=2)
titulo3 = Radiobutton(root, text="Esta es la tercera opción.", value=3, variable=x).grid(row=3)
titulo4 = Button(root, text="Enviar", command=lambda: visualizaOpcion(x.get())).grid(row=5)
